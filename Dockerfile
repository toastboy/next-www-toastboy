...
ARG AUTH_MICROSOFT_CLIENT_SECRET
ARG SENTRY_AUTH_TOKEN
ARG MAIL_FROM_ADDRESS
ARG MAIL_FROM_NAME
ARG MAIL_GRAPH_CLIENT_ID
ARG MAIL_GRAPH_CLIENT_SECRET
...
ENV AUTH_MICROSOFT_CLIENT_SECRET=${AUTH_MICROSOFT_CLIENT_SECRET}
ENV SENTRY_AUTH_TOKEN=${SENTRY_AUTH_TOKEN}
ENV MAIL_FROM_ADDRESS=${MAIL_FROM_ADDRESS}
ENV MAIL_FROM_NAME=${MAIL_FROM_NAME}
ENV MAIL_GRAPH_CLIENT_ID=${MAIL_GRAPH_CLIENT_ID}
ENV MAIL_GRAPH_CLIENT_SECRET=${MAIL_GRAPH_CLIENT_SECRET}
RUN npm run build

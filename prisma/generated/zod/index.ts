...
export const PlayerScalarFieldEnumSchema = z.enum(['id','login','isAdmin','name','anonymous','email','joined','finished','born','comment','introducedBy']);
...
export const PlayerOrderByRelevanceFieldEnumSchema = z.enum(['login','name','email','comment']);

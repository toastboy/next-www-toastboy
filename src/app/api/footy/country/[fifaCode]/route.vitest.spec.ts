...
import { GET } from '@/app/api/footy/country/[fifaCode]/route';
...
const mockApp = createMockApp(GET, { path: '/api/footy/country/NOR', params: Promise.resolve({ fifaCode: 'NOR' }) }, jsonResponseHandler);
...
describe('API tests using HTTP', () => {
    it('should return JSON response for a valid country', async () => {
        ...
        const response = await request(mockApp).get('/api/footy/country/NOR');

 ...
 * @returns A promise resolving to the response of the `handleGET` function, which fetches games played data.
 *
 * @remarks
 * - The `year` parameter is extracted from the route parameters.
 * - An optional query parameter `untilGameDayId` can be provided to filter games up to a specific game day.

...
describe('API tests using HTTP', () => {
    it('should return JSON response for a valid gameDay', async () => {
        (outcomeService.getTurnoutByYear as Mock).mockResolvedValue(defaultTurnoutByYearList);
    ...
    it('should return 404 if there is no data', async () => {
        (outcomeService.getTurnoutByYear as Mock).mockResolvedValue(null);
    ...
    it('should return 500 if there is an error', async () => {
        ...
        (outcomeService.getTurnoutByYear as Mock).mockRejectedValue(new Error(errorMessage));

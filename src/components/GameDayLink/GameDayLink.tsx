 ...
 *
 * @param gameDay - The game day data to link to
 * @param format - The format for the link label (default: 'iso')
 *   - 'iso': Displays the date in ISO 8601 format (e.g., "2024-06-01")
 *   - 'ordinal': Displays the day of the month with an ordinal suffix (e.g., "1st", "2nd")
 *   - 'numeric': Displays only the numeric day of the month (e.g., "1", "2")
 *   - 'left-arrow': Displays a left arrow icon, indicating a link to the previous game day
 *   - 'right-arrow': Displays a right arrow icon, indicating a link to the next game day
 * @returns A React element representing the formatted game day link
 */
...
/**
 * Renders a link to a game day with the specified format. The link includes a tooltip that shows the full date and any comment associated with the game day.
 *

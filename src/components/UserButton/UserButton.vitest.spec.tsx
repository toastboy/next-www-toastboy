...
describe('UserButton', () => {
    ...
    it('renders user name and email', async () => {
        ...
        await waitFor(() => {
            expect(
                screen.getByText('Harriette Spoonlicker'),
            ).toBeInTheDocument();
            expect(
                screen.getByText('hspoonlicker@outlook.com'),
            ).toBeInTheDocument();
        });
    });
    ...
    it('falls back to empty name and email when user values are null', async () => {
        ...
        expect(
            screen.queryByText(/harriette|spoonlicker/i),
    ...
    it('renders placeholder avatar when playerId is 0', async () => {
        ...
        expect(
            screen.queryByRole('img', { name: /api\/footy\/player/ }),
        ).not.toBeInTheDocument();
    });
    ...
    it('shows End impersonation item when user is being impersonated', async () => {
        ...
        expect(
            await screen.findByText('End impersonation'),
        ).toBeInTheDocument();
    });

...
async function importBackup(): Promise<void> {
    try {
        ...
        // Upload the JSON files to Azure Blob Storage (except PlayerRecord,
        // which is derived from Outcome and will be generated by the seeding
        // process)
        shellExec('rm -f /tmp/importlivedb/PlayerRecord.json');

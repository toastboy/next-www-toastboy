...
class PlayerService {
    ...
    */
     ...
     *
     * If no founder can be identified (e.g. the data contains only circular
     * references or no connections at all), an empty virtual root node named
     * "Toastboy FC" is returned with no children.
     *

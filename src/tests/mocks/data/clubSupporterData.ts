...
export const createMockClubSupporterData = (
    overrides: Partial<ClubSupporterDataType> = {},
): ClubSupporterDataType => ({
    ...defaultClubSupporterData,
    ...overrides,
});

export const defaultClubSupporterDataList: ClubSupporterDataType[] = Array.from(
    { length: 2 },
    (_, index) =>

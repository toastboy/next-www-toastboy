...
const playerRecordTestDataPath = path.join(__dirname, 'data/PlayerRecord.test.json');
...
describe('PlayerRecordService', () => {
    ...
    describe('getWinners', () => {
        beforeEach(() => {
            ...
            const playerRecordList: PlayerRecordType[] = JSON.parse(fs.readFileSync(playerRecordTestDataPath).toString());
    ...
    describe('getTable qualified/unqualified speedy', () => {
        beforeEach(() => {
            const playerRecordList: PlayerRecordType[] =
                JSON.parse(fs.readFileSync(playerRecordTestDataPath).toString());

...
export const CountrySupporterWriteInputSchema = z
    .object({
        ...CountrySupporterStrictFields,
    })
    .strip();

export type CountrySupporterWriteInput = z.infer<
    typeof CountrySupporterWriteInputSchema
>;

const CountrySupporterCreateDataStrictSchema = z.union([
    CountrySupporterCreateInputObjectZodSchema.extend(
        CountrySupporterStrictFields,
    ),
...
const CountrySupporterCreateOneStrictZodSchema =
    CountrySupporterCreateOneZodSchema.extend({
...
const CountrySupporterUpdateDataStrictSchema = z.union([
    CountrySupporterUpdateInputObjectZodSchema.extend(
        CountrySupporterStrictFields,
    ),
...
const CountrySupporterUpsertOneStrictZodSchema =
    CountrySupporterUpsertOneZodSchema.extend({
